...
import NewTeamWork from 'screens/new-teamwork/NewTeamWork';
const token = localStorage.getItem('red_wing_token');
const token_expiry_date = localStorage.getItem('red_wing_token_expiry_date');

function NewDashboard({ globalState, selectedProject, setSelectedProject, timer }) {
	...
	const getTeamWorkData = () => {
		setLoading(true);
		axios
			.get(`${process.env.REACT_APP_API_URL}/pages/team_work_hours.php`, {
				headers: {
